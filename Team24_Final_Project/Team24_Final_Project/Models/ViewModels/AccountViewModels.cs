...
{ 
    public enum RoleChoice { Customer, Host}
    ...
    {   
        ...
        [StringLength(1, ErrorMessage = "Middle Initial can only be a single letter")]
        ...
        [Required(ErrorMessage = "You must sign up as either a customer or host.")]
        public RoleChoice roleChoice { get; set; }

        public Boolean IsActive { get { return true; } }
    ...
    {
        public String UserToChangeID { get; set; }
